...
set AUTO443=--dpi-desync=fake,split --dpi-desync-split-seqovl=2 --dpi-desync-split-tls=sniext --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_dzen_ru.bin" --dpi-desync-fooling=md5sig,datanoack --dpi-desync-autottl=1
set YT443=--dpi-desync=fake,split2 --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_www_google_com.bin" --dpi-desync-split-seqovl=1 --dpi-desync-autottl=1
...
set GV443=--dpi-desync=disorder --dpi-desync-split-pos=2 --dpi-desync-split-tls=sniext --dpi-desync-fooling=datanoack --dpi-desync-repeats=8 --dpi-desync-autottl=1
