...
set AUTO443=--dpi-desync=fake,fakeddisorder --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_dzen_ru.bin" --dpi-desync-fakedsplit-pattern="%~dp0fake\tls_clienthello_dzen_ru.bin" --dpi-desync-split-seqovl=1 --dpi-desync-split-pos=sniext+1 --dpi-desync-fooling=md5sig,badseq --dpi-desync-autottl=1 --dpi-desync-repeats=3
...
set BLACKLIST443=--dpi-desync=fake,multidisorder --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_dzen_ru.bin" --dpi-desync-split-pos=1,midsld+4,sniext-2,endhost-7 --dpi-desync-fooling=md5sig,datanoack --dpi-desync-autottl=1 --dpi-desync-repeats=3
