...
set AUTO443=--dpi-desync=fake,multidisorder --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_stepik_org.bin" --dpi-desync-split-seqovl=1 --dpi-desync-split-pos=1,midsld,endsld+1,sniext+2,host+1,endhost-3 --dpi-desync-fooling=md5sig --dpi-desync-autottl=1 --dpi-desync-repeats=3
...
set BLACKLIST443=--dpi-desync=fake,multidisorder --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_yandex_net.bin" --dpi-desync-split-seqovl=1 --dpi-desync-split-pos=2,midsld+2,sniext,endhost-4 --dpi-desync-fooling=md5sig --dpi-desync-autottl=1 --dpi-desync-repeats=3
