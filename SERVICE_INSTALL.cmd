...
set BLACKLIST80=--dpi-desync=fake,multidisorder --dpi-desync-fake-http="%~dp0fake\http_iana_org.bin" --dpi-desync-split-seqovl=5 --dpi-desync-split-pos=7,method+2,host+4,-32 --dpi-desync-fooling=md5sig,badseq --dpi-desync-autottl=1 --dpi-desync-autottl6=1 --dpi-desync-repeats=3
...
set QUIC443=--dpi-desync=fake,udplen --dpi-desync-fake-quic="%~dp0fake\quic_initial_vk_com.bin" --dpi-desync-udplen-increment=8 --dpi-desync-udplen-pattern=0xDEADBEEF --dpi-desync-autottl=1 --dpi-desync-autottl6=1 --dpi-desync-repeats=8

set DISQ50000=--dpi-desync=fake,udplen --dpi-desync-fake-unknown-udp="%~dp0fake\quic_initial_vk_com.bin" --dpi-desync-udplen-increment=24 --dpi-desync-cutoff=d2 --dpi-desync-any-protocol --dpi-desync-repeats=4
:: -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= ::
