...
set BLACKLIST443=--dpi-desync=fake,multisplit --dpi-desync-repeats=6 --dpi-desync-fake-tls="%~dp0fake\tls_clienthello_www_google_com_tls13.bin" --dpi-desync-fake-tls-mod=none --dpi-desync-split-seqovl=496 --dpi-desync-split-seqovl-pattern="%~dp0fake\tls_clienthello_vk_com_tls13.bin" --dpi-desync-split-pos=sld-42,sld-36,sld-24,sld-18,sld-5,sld-2,sld,midsld-2,midsld,midsld+2,endsld+1,endsld+2,endsld+7,endsld+14,endsld+21,endsld+33,endsld+42,endsld+52,endsld+69,endsld+127 --dpi-desync-fooling=md5sig,datanoack
